...
[_vehicle, ["<t color='#FFFF00>Repair"</t>, { [_this select 0] remoteExec ["xenoRepair", _this select 0]; },nil,0.0.19,true,true,"","true",5,false,"",""]] remoteExec ["addAction", 0, "addrepair" + (_vehicle call BIS_fnc_netId)];
